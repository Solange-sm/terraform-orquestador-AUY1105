...
default allow = {
    "status": false,
    "reason": "La instancia no cumple con la nomenclatura obligatoria AUY1105_etsmc-ec2 o no es tipo t2.micro."
}
...
allow = result if {
    ...
    resource.change.after.tags.Name == "AUY1105_etsmc-ec2"
