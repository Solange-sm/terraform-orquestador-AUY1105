...
module "redes" {
  ...
  source       = "git::https://github.com/Solange-sm/terraform-aws-vpc-AUY1105.git?ref=v1.0.0"
...
module "computo" {
  ...
  source            = "git::https://github.com/Solange-sm/terraform-aws-ec2-AUY1105.git?ref=v1.0.0"
